            ...
            <main className="flex-1">
                    ...
                    <section className="container">
                        <section className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                            <img
                                ...
                                className="px-4"
                            />
                            <section className="px-4 md:px-6 bg-background flex flex-col justify-center space-y-4">
                ...
                <section className="border-t-[42px] border-t-background md:border-t-[96px] lg:border-t-[128px] xl:border-t-[192px] px-4 w-full py-12 md:py-24 lg:py-32 bg-muted">
                    <section>
                        ...
                        <section className="grid gap-12 sm:gap-6 lg:grid-cols-3">
                            <List
                                items={INFOS}
...
function InfoSection({ title, subTitle, Icon }: InfoSectionProps) {
    return (
        <section className="flex flex-col items-center space-y-4 text-center">
            <section className="bg-primary text-primary-foreground rounded-full p-4">
                <Icon />
            </section>
